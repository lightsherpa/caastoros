...
window.CI_SPECIALIST_SPECS = {
  ...
  a04: {
    ...
    objective: "Surface the one tension with enough truth and consequence to generate strategy or creative work, then show how to use it without flattening it into a slogan.",
