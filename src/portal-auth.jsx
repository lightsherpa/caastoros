    ...
    <div className={"auth-split" + (isTeam ? " auth-split--team" : "")}>
      ...
      <aside className="auth-story" aria-hidden="true">
        ...
        <div className="auth-story__copy">
          ...
          <p className="auth-story__sub">Brandolph reads your brand into a living BIO, a senior human certifies it, and the crew lands the work on a canvas — with human finishing on any output you choose.</p>
