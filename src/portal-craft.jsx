  ...
  return (
    <div style={{padding:"24px 36px 60px"}}>
      ...
      <div style={{display:"grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14, marginBottom: 30}}>
        {[
          { title:"Hero KV finish · sample brief",     who:"Team member", state:"in-progress", eta:"in 36h", cr:220 },
          { title:"Long-form essay · finishing pass",  who:"Team member", state:"review",      eta:"awaiting your approval", cr:120 },
          { title:"Investor deck · polish",            who:"Team member", state:"delivered",   eta:"delivered yesterday",     cr:300 },
        ].map((j, i) => (
        ...
        <section className="card" style={{padding: 28}}>
            ...
            <div style={{display:"flex", flexDirection:"column", gap: 18, maxWidth: 480}}>
              ...
              <div><label style={{display:"block", fontSize:12, fontWeight:500, marginBottom: 6}}>Workspace logo</label>
                <div style={{display:"flex", gap: 12, alignItems:"center"}}>
                  <div style={{width:56, height:56, borderRadius: 10, background:"var(--neutral-900)", color:"#fff", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"var(--font-mono)", fontWeight:600, fontSize:24}}>Y</div>
          ...
          {tab === "members" && (
            <div>
              ...
              <div style={{display:"flex", flexDirection:"column", gap: 8}}>
                {[
                  { name:"Team member", email:"owner@example.com", role:"Owner", p:"caastor/assets/profile-3.jpg" },
                  { name:"Team member", email:"member@example.com", role:"Member", p:"caastor/assets/profile-2.jpg" },
                  { name:"Team member", email:"viewer@example.com", role:"Viewer", p:"caastor/assets/profile-4.jpg" },
                ].map((m, i) => (
